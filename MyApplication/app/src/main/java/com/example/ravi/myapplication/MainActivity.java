...
import com.example.ravi.myapplication.GraphicOverlay;
import com.example.ravi.myapplication.R;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageView = findViewById(R.id.image_view30);
    ...
    private void processCloudTextRecognitionResult(FirebaseVisionCloudText texts) {
        ...
        List<FirebaseVisionCloudText.Page> pages = texts.getPages();
